...
<div style="margin: 20px auto; background-color: #fff; border: 1px solid #ddd; border-radius: 8px; overflow: hidden; box-shadow: 0 2px 8px rgba(0, 0, 0, 0.1);">
    <div style="background-color: #003a6d; padding: 20px; text-align: center;">
        <img src="' . {{ URL::asset('assets/logos/HumanOp Logo.png') }} . '" alt="HumanOP Logo" style="height: 50px;">
    </div>
    <div style="padding: 20px; color: #333; background-color: #f3deba;">
        ...
        <div style="display: flex; justify-content: center;">
            <a href="{$link}" style="margin: 20px 0; padding: 12px 20px; background-color: #003a6d; color: #fff; text-decoration: none; border-radius: 20px; font-size: 16px;">Verify Your Email</a>
        </div>
    ...
    <div style="text-align: center; padding: 20px; background-color: #f3deba; color: black;">
        ...
        <p style="font-size: 12px; line-height: 1.5; margin: 8px 0; color: black;">
            ...
            that you agree to our <a href="' . route('term_of_service') . '" style="color: #003a6d; text-decoration: none;">Terms of Service</a> and <a
                href="' . route('privacy') . '" style="color: #003a6d; text-decoration: none;">Privacy Policy</a>. If you no longer want to receive mails from
            us.
        </p>
    </div>
</div>
