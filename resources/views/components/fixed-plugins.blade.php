<div class="fixed-plugin">
    <a class="fixed-plugin-button text-dark position-fixed px-3 py-2">
        <i class="fa fa-commenting py-2"> </i>
    </a>
    <div class="card shadow-lg blur" style="background-color: #0f1534 !important;">
        ...
        <div class="chatbox">
            <div class="chatbox-content" id="chatbox-content">
                <div class="message bot-message">Welcome to our store! Whether you have a specific question or need
                    assistance, we're here for you. What would you like to know? 😊
                </div>
                <div class="message user-message">Shopping guide </div>
                <div class="message bot-message">Don’t spend hours searching for the right product. We’ll help you find
