                    ...
                    <div class="row w-100 introAssessmentMargin">
                        <div class="col-lg-7 col-md-7 col-12">
                            ...
                            <h4 class="text-white text-bold">"Creating Optimal Relationships in Business, Home &
                                Life"</h4>
                            <p class="text-white" style="display: flex; text-align: justify">Our evolutionary human assessment technology is designed to help you
                            ...
                            <p class="text-white" style="display: flex; text-align: justify">Before you take the HumanOp Assessment make sure that you are NOT
                                multi-tasking and ideally in a quiet environment where you can focus on being present to
                                the following questions.</p>
                            <p class="text-white" style="display: flex; text-align: justify">The questions are simple and do not require extensive thought. It
                        ...
                        <div class="col-lg-5 col-md-5 col-12 introAssessmentLogo" >
