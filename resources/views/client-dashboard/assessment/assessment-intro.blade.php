                    ...
                    <div class="row w-100 introAssessmentMargin">
                        <div class="col-lg-7 col-md-7 col-12 mt-2">
                            ...
                            <h4 class="text-white text-bold pl-14">"Creating Optimal Relationships in Business, Home &
                                Life"</h4>
                            <p class="text-white pl-14" style="display: flex; text-align: justify">Our evolutionary human assessment technology is designed to help you
                            ...
                            <p class="text-white pl-14" style="display: flex; text-align: justify">Before you take the HumanOp Assessment make sure that you are NOT
