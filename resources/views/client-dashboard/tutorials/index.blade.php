...
@section('content')
                                        ...
                                        <div class="col-8 m-auto">
                                            <div class="numbers">
                                                <p class="text-sm mb-0 text-capitalize font-weight-bold"
                                                   style="color: white;">{{$tutorial['name'] ?? null}}</p>
                                            </div>
                                        </div>
    ...
    @foreach($tutorials as $tutorial)
        <div class="modal fade" id="tutorial-{{$tutorial['id']}}" tabindex="-1"
             role="dialog"
                ...
                <div class="modal-content">
                    <div class="modal-body" style=" border-radius: 9px">
                        <div class="card-body pt-0">
                            <label class="form-label fs-4 text-white">{{$tutorial['name']}}</label>
