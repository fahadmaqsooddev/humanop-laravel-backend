    ...
    <div class="container-fluid">
        ...
        <div class="card card-body blur shadow-blur mx-4 mt-n6 overflow-hidden">
            <div class="row gx-4">
                ...
                <div class="col-lg-5 col-md-5  ms-sm-auto me-sm-0 mx-auto mt-3">
            ...
            <div class="col-12 col-lg-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <img alt="Image placeholder" src="{{ URL::asset('assets/img/teams-image.png') }}" class="img-fluid border-radius-lg shadow-lg">
                        ...
                        <div class="mb-1">
                            <div class="d-flex text-white">
                                ...
                                <div class="flex-grow-1 ms-3">
                                    ...
                                    <p class="text-sm text-white">I always felt like I could do anything. That’s the main thing people are controlled by! Thoughts- their perception of themselves!</p>
                                    <div class="d-flex text-white">
                                        <div>
                                            <i class="ni ni-like-2 me-1 cursor-pointer"></i>
                                        </div>
                            ...
                            <div class="d-flex mt-3">
                                ...
                                <div class="flex-grow-1 ms-3">
                                    ...
                                    <p class="text-sm text-white">Society has put up so many boundaries, so many limitations on what’s right and wrong that it’s almost impossible to get a pure thought out. It’s like a little kid, a little boy.</p>
                                    <div class="d-flex text-white">
                                        <div>
                                            <i class="ni ni-like-2 me-1 cursor-pointer"></i>
                                        </div>
