    ...
    <div class="col-lg-7 position-relative z-index-2">
        ...
        <div class="row">
            ...
            <div class="col-lg-5 col-sm-5">
                {{-- <a data-bs-toggle="modal" --}} {{-- data-bs-target="#introduction">--}}
                    ...
                    {{-- <a data-bs-toggle="modal" --}} {{-- data-bs-target="#cycle_of_life">--}}
            ...
            <div class="col-lg-5 col-sm-5 mt-sm-0 mt-4">
                {{-- <a data-bs-toggle="modal" --}} {{-- data-bs-target="#trait">--}}
                    ...
                    {{-- <a data-bs-toggle="modal" --}} {{-- data-bs-target="#motivation">--}}
        ...
        <div class="row mt-4">
            <div class="col-lg-5 col-sm-5">
                {{-- <a data-bs-toggle="modal" --}} {{-- data-bs-target="#alchemy">--}}
                    ...
                    {{-- <a data-bs-toggle="modal" --}} {{-- data-bs-target="#energy">--}}
            ...
            <div class="col-lg-5 col-sm-5 mt-4 mt-md-0">
                {{-- <a data-bs-toggle="modal" --}} {{-- data-bs-target="#communication">--}}
...
<button data-bs-toggle="modal" data-bs-target="#life" hidden>
    modal button
</button>
        ...
        {{-- <div class="modal-content">--}}
            {{-- <div class="modal-body" style="background-color: #0f1535;  border-radius: 9px">--}}
                {{-- <video id="introduction-video" controls>--}}
                    {{--
                    <source src="{{ asset('assets/video/HumanOp ULT Results Intro - Lisa Nelson.mp4') }}"
                        type="video/mp4">--}}
    ...
    <div class=" d-flex justify-content-center align-items-center h-100 w-100 ">
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content w-100">
                <div class="modal-body   " style="background-color: #0f1535; border-radius: 9px">
                    <button type="button" class="close  modal-close-btn mb-3 " data-bs-dismiss="modal" aria-label="Close">
...
{{-- <a class="git-icon" href="https://github.com/vaibhav1663" target="_blank">--}}
    ...
    {{-- </a>--}}
{{-- <video src="https://vaibhav1663.github.io/Youtube-Ambient-Mode/demo-video.mp4"
    poster="https://vaibhav1663.github.io/Youtube-Ambient-Mode/poster.jpg" id="blurred"></video>--}}
