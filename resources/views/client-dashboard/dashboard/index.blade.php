                ...
                <div class="modal-body" style=" border-radius: 9px">
                    <div class="card-body pt-0">
                        ...
                        <div class="card-body pt-0 text-white">
                            ...
                            <p class="text-white">
                                Ready to discover what makes you truly unique and learn the actionable steps to optimize
                                your life? Click the link to get started!
                            </p>
                            <div class="d-flex justify-content-between">
                                <button id="start-tour" data-bs-dismiss="modal" aria-label="Close"
                                        class="btn-sm mt-2 mb-0 rainbow-border-user-nav-btn"
