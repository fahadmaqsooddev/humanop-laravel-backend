                        ...
                        <div class="col-12">
                            <div class="card" style="text-align: center">
                                <div class="card-body p-3 ">
                                    ...
                                    <p style="color:#f2661c; text-align: start">Your natural physical "TRAITS" determine
                                    ...
                                    @foreach($reports['style_code_details'] as $report)
                                        <h2 class="mt-4"
                                            style="color: #f2661c; text-align: start">{{$report['public_name']}}</h2>
                                        <p class="text-white" style="text-align: start">{{$report['text']}}</p>
                                    @endforeach

                                    <h2 class="mt-4" style="color: #f2661c; text-align: start">YOUR MOTIVATION</h2>
                                    <p class="text-white" style="text-align: start"> Your "MOTIVATION" addresses what
                                    ...
                                    <h2 class="mt-4" style="color: #f2661c; text-align: start">YOUR BOUNDARIES</h2>
                                    <p class="text-white" style="text-align: start"> “ALCHEMY” addresses your refinement
                                    ...
                                    <h2 class="mt-4" style="color: #f2661c; text-align: start">YOU HAVE A
                                    ...
                                    <p class="text-white mt-4"
                                       style="text-align: start">{{$reports['alchemy_code_details']['text']}}</p>

                                    <h2 class="mt-4" style="color: #f2661c; text-align: start">YOUR COMMUNICATION
                                        STYLE</h2>
                                    <p class="text-white" style="text-align: start">“ENERGY CENTERS” define your
                                    ...
                                    @foreach($reports['communication_code_details'] as $report)
                                        <h2 class="mt-4"
                                            style="color: #f2661c; text-align: start">YOU are primarily {{$report['public_name']}} centered</h2>
                                        <p class="text-white" style="text-align: start">{{$report['text']}}</p>
                                    @endforeach

                                    <h2 class="mt-4" style="color: #f2661c; text-align: start">YOUR PERCEPTION OF LIFE</h2>
                                    <p class="text-white mt-4"
                                       style="text-align: start">{{$reports['perception_life']['text']}}</p>

                                    <h2 class="mt-4" style="color: #f2661c; text-align: start">{{$reports['polarity_code_detail']['public_name']}}</h2>
                                    <p class="text-white mt-4"
                                       style="text-align: start">{{$reports['polarity_code_detail']['text']}}</p>

                                    <h2 class="mt-4" style="color: #f2661c; text-align: start">YOUR ENERGY POOL</h2>
                                    <p class="text-white mt-4" style="text-align: start">Your “ENERGY POOL” represents how much physical energy you have to expend on a daily
                                    ...
                                    <h2 class="mt-4" style="color: #f2661c; text-align: start">{{$reports['energy_code_detail']['public_name']}}</h2>
                                    <p class="text-white mt-4"
                                       style="text-align: start; padding-bottom: 20px; border-bottom: 2px solid #f2661c">{{$reports['energy_code_detail']['text']}}</p>

                                    <div style="text-align: start" class="text-white mt-4"
                                    ...
                                    <p class="text-white mt-4" style="text-align: start; padding-bottom: 20px; border-bottom: 2px solid #f2661c">Your practitioner is {{\Illuminate\Support\Facades\Auth::user()['first_name']}} {{\Illuminate\Support\Facades\Auth::user()['last_name']}} <br>{{\Illuminate\Support\Facades\Auth::user()['email']}}</p>
                                    <p class="text-white mt-4" style="text-align: start">For internal use only. <br>Compatibility values for BR {{\Illuminate\Support\Facades\Auth::user()['gender'] == 1 ? '(F)' : '(M)'}} Interval</p>
                                    <p class="text-white mt-4" style="text-align: start">PV {{$reports['pv'] > 0 ? '+' : ''}} {{$reports['pv']}}  REP ARC {{$reports['pv'] - $reports['ep']}} to +{{$reports['pv'] + $reports['ep']}}</p>
                                    <p class="text-white mt-4" style="text-align: start">REP {{$reports['ep']}}</p>
                                    <p class="text-white mt-4" style="text-align: start">TEP {{$reports['ep'] * 2}}</p>
                            </div>
                        </div>
                    </div>
                </section>
