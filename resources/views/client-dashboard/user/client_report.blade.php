                                ...
                                <div class="card-body p-3 ">
                                    ...
                                    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                                        <ol class="carousel-indicators">
                                            ...
                                            @foreach($reports['style_code_details'] as $key => $report)
                                                <li data-target="#carouselExampleIndicators" data-slide-to="{{$key + 4}}"></li>
                                            @endforeach
                                            <li data-target="#carouselExampleIndicators" data-slide-to="6"></li>
                                            @foreach($reports['feature_code_details'] as $key => $report)
                                                <li data-target="#carouselExampleIndicators" data-slide-to="{{$key + 7}}"></li>
                                            @endforeach
                                            <li data-target="#carouselExampleIndicators" data-slide-to="9"></li>
                                            <li data-target="#carouselExampleIndicators" data-slide-to="10"></li>
                                            <li data-target="#carouselExampleIndicators" data-slide-to="11"></li>
                                            @foreach($reports['communication_code_details'] as $key => $report)
                                                <li data-target="#carouselExampleIndicators" data-slide-to="{{$key + 12}}"></li>
                                            @endforeach
                                        ...
                                        <div class="carousel-inner" >
                                            ...
                                            <div class="carousel-item">
                                                <p class="slider-padding">This advanced human assessment curriculum and technology are products of YCG, LLC dba The YOU Institute. The curriculum is approved for continuing education by The California State Board of Behavioral Sciences, The Board of Registered Nursing and the International Coach Federation. The ULT Performance Report is helpful to employers and various agencies seeking compatibility in people placement as well as professionals trained in relationship management and psychotherapy. Your ULT Performance Report adds intrinsic value in fortifying relationships, seeking a career, preparing for marriage, selecting a roommate and in better understanding yourself and others.</p>
                                                <video class="slider-padding mb-5" width="900" height="450"  controls muted >
                                                    <source src="{{asset('video.mp4')}}" type="video/mp4">
                                                    <source src="mov_bbb.ogg" type="video/ogg">
                                                    Your browser does not support HTML video.
                                            ...
                                            <div class="carousel-item">
                                                <h2 class="slider-padding" style="color: #f2661c">The ULT Performance Report addresses the
                                                    following:</h2>
                                                <ul class="slider-padding" style="padding-right: 100px;padding-left: 100px">
                                            ...
                                            @foreach($reports['communication_code_details'] as $report)
                                                <div class="carousel-item">
                                                    <h2 class="slider-padding"
                                                        style="color: #f2661c;">YOU are primarily {{$report['public_name']}} centered</h2>
                                                    <p class="slider-padding">{{$report['text']}}</p>
                                                    <video class="slider-padding mb-5" width="900" height="450"  controls muted >
                                                        <source src="{{asset('video.mp4')}}" type="video/mp4">
                                                        <source src="mov_bbb.ogg" type="video/ogg">
                                            ...
                                            @endforeach
                                            <div class="carousel-item">
                                                <h2 class="slider-padding" style="color: #f2661c;">YOUR PERCEPTION OF LIFE</h2>
                                            ...
                                            <div class="carousel-item">
                                                <h2 class="slider-padding" style="color: #f2661c;">{{$reports['polarity_code_detail']['public_name']}}</h2>
                                            ...
                                            <div class="carousel-item">
                                                ...
                                                <p class="slider-padding">Your “ENERGY POOL” represents how much physical energy you have to expend on a daily
                                            ...
                                            <div class="carousel-item">
                                                <h2 class="slider-padding" style="color: #f2661c;">{{$reports['energy_code_detail']['public_name']}}</h2>
                                            ...
                                            <div class="carousel-item">
                                                ...
                                                <p class="slider-padding">Your practitioner is {{\Illuminate\Support\Facades\Auth::user()['first_name']}} {{\Illuminate\Support\Facades\Auth::user()['last_name']}} <br>{{\Illuminate\Support\Facades\Auth::user()['email']}}</p>
                                                <video class="slider-padding mb-5" width="900" height="450"  controls muted >
                                                    <source src="{{asset('video.mp4')}}" type="video/mp4">
                                                    <source src="mov_bbb.ogg" type="video/ogg">
                                                    Your browser does not support HTML video.
                                            ...
                                            <div class="carousel-item">
                                                <p class="slider-padding" >For internal use only. <br>Compatibility values for BR {{\Illuminate\Support\Facades\Auth::user()['gender'] == 1 ? '(F)' : '(M)'}} Interval</p>
                                                <p class="slider-padding" >PV {{$reports['pv'] > 0 ? '+' : ''}} {{$reports['pv']}}  REP ARC {{$reports['pv'] - $reports['ep']}} to +{{$reports['pv'] + $reports['ep']}}</p>
