                    ...
                    <div class="table-responsive">
                        <table class="table table-flush" style="border-collapse: separate">
                            ...
                            <tr>
                                ...
                                <td class="text-sm font-weight-normal text-center {{ $grid_code_color && isset($grid_code_color['so']) && $grid_code_color['so'] == 'border-green' ? 'border-green' : 'border' }} @if(in_array('so', array_keys($grid_code_color))) {{ $grid_code_color['so'] }} @endif">{{$third_row_so = 10 * $grid['so']}}</td>
                    ...
                    <div class="table-responsive">
                        <table class="table table-flush" style="border-collapse: separate">
                            ...
                            <tr>
                                ...
                                <td class="text-sm font-weight-normal text-center border border-white @if(in_array('gre', array_keys($grid_code_color))) {{ $grid_code_color['gre'] }} @endif">{{$second_row_gre = $grid['mer']}}</td>
