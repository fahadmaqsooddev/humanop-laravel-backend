            ...
            foreach ($features as $key => $value) {
                switch ($key) {
                    case 'de':
                        ...
                        break;
                    case 'dom':
                        if (($grid['dom'] > 2 && ($grid['sa'] > 4 || $grid['ma'] > 4)) || ($grid['dom'] > 2 && $grid['ma'] > 4 && $grid['mer'] > 4 && $grid['sa'] > 4 && $grid['jo'] > 4)) {
                            $filtered_keys[$key] = $value;
                        }
                        ...
                        break;
                    case 'fe':
                        if (($grid['fe'] > 2 && ($grid['ma'] > 4 || $grid['lu'] > 4 || $grid['ven'] > 4)) || ($grid['fe'] > 2 && $grid['sa'] > 4 && $grid['jo'] > 4 && $grid['ven'] > 4 && $grid['lu'] > 4 && $grid['mer'] > 4)) {
                            $filtered_keys[$key] = $value;
                        }
                        ...
                        break;
                    case 'gre':
                        if (($grid['gre'] > 2 && ($grid['jo'] > 6)) || ($grid['gre'] > 2 && $grid['ven'] > 4 && $grid['so'] > 4)) {
                            $filtered_keys[$key] = $value;
                        }
                        elseif (($grid['gre'] > 2 && ($grid['jo'] < 6)) && ($grid['ma'] < 5 || $grid['lu'] < 5)) {
                            $filtered_keys_red[$key] = $value;
                        }
                        break;
                    case 'lun':
                    ...
                    case 'nai':
                        ...
                        break;
                    case 'ne':
                        if (($grid['ne'] > 2 && ($grid['sa'] > 4 || $grid['lu'] > 4 || $grid['ven'] > 4)) || ($grid['ne'] > 2 && $grid['ma'] > 4 && $grid['mer'] > 4 && $grid['ven'] > 4 && $grid['jo'] > 4 && $grid['lu'] > 4)) {
                            $filtered_keys[$key] = $value;
                        }
                        ...
                        break;
                    case 'pow':
                        if (($grid['pow'] > 2 && ($grid['jo'] > 4 || $grid['mer'] > 4)) || ($grid['pow'] > 2 && $grid['ma'] > 4 && $grid['lu'] > 4 && $grid['ven'] > 4 && $grid['sa'] > 4)) {
                            $filtered_keys[$key] = $value;
                        }
                    ...
                    case 'sp':
                        ...
                        break;
                    case 'tra':
                        if (($grid['tra'] > 2 && ($grid['jo'] > 4 || $grid['ven'] > 4)) || ($grid['tra'] > 2 && $grid['ma'] > 4 && $grid['lu'] > 4 && $grid['mer'] > 4)) {
                            $filtered_keys[$key] = $value;
                        }
                        elseif (($grid['tra'] > 2 && ($grid['jo'] < 5 && $grid['ven'] < 5)) && ($grid['ma'] < 5 || $grid['lu'] < 5 || $grid['mer'] < 5)) {
                            $filtered_keys_red[$key] = $value;
                        ...
                        break;
                    case 'van':
                        if (($grid['van'] > 2 && ($grid['jo'] > 4 || $grid['ven'] > 4 || $grid['mer'] > 4 || $grid['so'] > 4)) || ($grid['van'] > 2 && $grid['ma'] > 4 && $grid['lu'] > 4 && $grid['mer'] > 4 && $grid['ven'] > 4 && $grid['sa'] > 4)) {
                            $filtered_keys[$key] = $value;
                        }
                        ...
                        break;
                    case 'wil':
                        if (($grid['wil'] > 2 && ($grid['ma'] > 4 || $grid['lu'] > 4)) || ($grid['wil'] > 2 && $grid['sa'] > 4 && $grid['jo'] > 4 && $grid['ven'] > 4)) {
                            $filtered_keys[$key] = $value;
                        }
