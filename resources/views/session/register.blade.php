                    ...
                    <div class="card-body" >
                        <form action="{{route('store_user')}}" method="post">
                            ...
                            <div class="mt-3" hidden>
                                <div class=" ">
                                    <label for="email" style="color: #0f1535; font-size: 15px">Google id in case of signup from
                                        google</label>
                            ...
                            <div class="mt-3 position-relative" {{$google_user ? 'hidden' : ""}}>
                                <div>
                                    <label for="password" style="color: #0f1535; font-size: 15px">Confirm Password</label>
                            ...
                            <div class="mt-3">
                                <div class="">
                                    <label for="name" style="color: #0f1535; font-size: 15px">Gender at Birth</label>
                            ...
                            <p class="text-sm mt-3 mb-0" style="color: #0f1535">Already have an account?
                                <a href="{{ url('login') }}" class=" font-weight-bolder" style="color: #0f1535">Sign in</a>
                            </p>
                        </form>
                    </div>
                </div>
