                ...
                <div class="col-xl-4 col-lg-5 col-md-7 mx-auto">
                    <div class="card z-index-0">
                        ...
                        <div class="css-mgpqwz d-flex justify-content-center">
                                ...
                                <a href="#">
                                    <button class="btn btn-primary p-2 border border-radius-lg border-gray-800"
                                        ...
                                        <svg style="margin: 13px" stroke="currentColor" fill="currentColor"
                                             ...
                                             class="material-icons-round notranslate" aria-hidden="true" height="22px"
                                             width="22px"
                            ...
                            <a href=" #
                            ">
                            <button class="btn btn-primary p-2 border border-radius-lg border-gray-800" type="button"
                                    style="background-color: rgb(19, 21, 54);">
                                <svg style="margin: 13px" stroke="currentColor" fill="currentColor" stroke-width="0"
                    ...
                    <form role="form" class="text-start" action="{{url('/session')}}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="password" class="form-control" placeholder="Password" aria-label="Password"
                                   value="" name="password" id="password" required
                        ...
                        <p class="text-sm text-center mt-3 mb-0" style="color: rgb(160, 174, 192)">Don't have an
                            account? <a href="{{ url('register') }}" class="text-dark font-weight-bolder">Sign up</a>
                        </p>
