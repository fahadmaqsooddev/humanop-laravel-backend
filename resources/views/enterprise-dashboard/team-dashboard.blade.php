            ...
            <div class="col-12 col-lg-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <img alt="Image placeholder" src="{{ URL::asset('assets/img/team-1.jpg') }}" class="img-fluid border-radius-lg shadow-lg">
                            </div>
                            <div class="col-lg-6">
                                <img alt="Image placeholder" src="{{ URL::asset('assets/img/team-2.jpg') }}" class="img-fluid border-radius-lg shadow-lg">
                            </div>
                        </div>
                    </div>
                </div>
