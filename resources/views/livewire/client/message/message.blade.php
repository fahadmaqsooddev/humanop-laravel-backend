<div>
    <div class="row position-relative mb-2 mt-4 mx-3"
        style="height: auto; padding:10px;background: #8BB1AB;border-radius: 40px !important;">
        <div class="row  sepratediv" style="background: #8BB1AB;border-radius: 40px !important;">
        ...
        <div class="position-absolute"
            style="right: -10px;top: -25px;height: 60px;width: 60px;border-radius: 50%;background: #1C365E;padding-left: 5px;border: 10px solid #8BB1AB">
            <img src="{{ asset('assets/new-design/icon/dashboard/bell.svg') }}" alt="notification" width="30"
                height="40">
        </div>
        <div class="position-absolute" style="left: 40%">
            <img src="{{ asset('assets/new-design/icon/dashboard/header_badge.svg') }}" alt="notification"
                style="width: 10%" height="120">
        </div>
    </div>
    <div class="body-container d-flex flex-column flex-md-row align-items-center align-items-md-stretch  p-2 pb-5">
        <div class="side-bar w-md-25" id="message-bar">
            <div class="row">
                ...
                <div class="col-3">
                    ...
                    <div>
                        <ul class="nav nav-tabs w-100 bg-dark" style="border-radius: 15px" role="tablist">
                            <li class="nav-item w-50">
                                <a class="nav-link active text-light text-center" style="border-radius: 15px"
                                   data-bs-toggle="tab" href="#tabs-1"
                                   role="tab">Messages</a>
                            </li>
                            <li class="nav-item w-50">
                                <a class="nav-link text-light text-center" style="border-radius: 15px" data-bs-toggle="tab"
                                   href="#tabs-2" role="tab">Connections</a>
                            </li>
                        </ul>
                    </div>
                    <form class="messenger-search-form d-flex align-items-center justify-content-center ">
                        ...
                        <input wire:model="filter_text" style="color: #F95520" type="text" id="search-bar"
                               class="form-control searchUser" placeholder="Search" maxlength="25">
                    </form>
            ...
            <div class="tab-content">
                <div class="tab-pane messenger-cards" id="tabs-2" role="tabpanel">
                    ...
                    <div class="row">
                        ...
                        <div class="col-9" style="margin-top: -65px;">
                            ...
                            @if (empty($connections[0]))
                                <p class="p-2">No connection found</p>
                            @endif
                            ...
                            @endphp
                            <div class="row pt-2 connection-user-card w-md-75 d-flex">
                                            ...
                                            <div class="card-body d-flex flex-column justify-content-end"
                                                ...
                                                <div class="card-img flex-grow-5 position-absolute z-index-2" style="top:30px;">
                                                    ...
                                                    <h6 class="card-title mt-1 mb-0"
                                                        ...
                                                        {{ $connection['friend'] ? substr($connection['friend']['first_name'], 0, 25) : '' }}
                                                    </h6>
                                                    <h6 class="card-title mt-1 mb-2"
                                                        style="cursor:pointer; color: #1E1D1D;font-weight: 700;">
                                                        {{ $connection['friend'] ? substr($connection['friend']['last_name'], 0, 25) : '' }}
                                                    </h6>
                                                    <div class="d-flex justify-content-center">
                                                        <img src="{{ asset('assets/new-design/icon/connection/like.svg') }}"
                                                             height="20" width="20" />
                                                        <img src="{{ asset('assets/new-design/icon/connection/comment.svg') }}"
                                                ...
                                                <div class="profileCard mb-4" style="color: rgb(74, 74, 74);padding:5px 0px;">
                                                    <div class="p-1">
                                                        @if ($connection['friend']['connection_status'] === 0)
                                                            <a class="connection-btn px-3 py-2"
                                                               wire:click="connectUnConnectUser({{ $connection['friend']['id'] }},'connect')"
                                                               style=' font-size: x-small; font-weight: 700;'>Connect</a>
                                                        @elseif($connection['friend']['connection_status'] === 1)
                                                            <a class="connection-btn px-3 py-2"
                                                               wire:click="connectUnConnectUser({{ $connection['friend']['id'] }},'un-connect')"
                                                               style="font-size: x-small; font-weight: 700;">Connected</a>
                                                        @elseif($connection['friend']['connection_status'] === 2)
                                                            <a class=" connection-btn px-3 py-2"
                                                               wire:click="connectUnConnectUser({{ $connection['friend']['id'] }},'un-connect')"
                                                               style="font-size: x-small; font-weight: 700;">Pending</a>
                                                        @elseif($connection['friend']['connection_status'] === 3)
                                                            <a class="connection-btn px-3 py-2"
                                                               wire:click="connectUnConnectUser({{ $connection['friend']['id'] }},'accept')"
                                                               style="font-size: x-small; font-weight: 700;">Accept</a>
                                                        @endif
                                                    </div>
                                                    <div class="p-1">
                                                        <a class="connection-btn px-3 py-2"
                                                           wire:click="messages('',{{ $connection['friend'] ?? null }})"
                                                           style="font-size: x-small; font-weight: 700;">Message</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                ...
                <div class="tab-pane active w-100" id="tabs-1" role="tabpanel">
                    ...
                    <div class="row">
                        ...
                        <div class="col-9" style="margin-top: -65px;">
                            ...
                            @if ($chat_user)
                                <div class="messenger-container messenger-cards show-messenger pb-2 flex-grow-1 w-sm-100 w-md-75 d-flex flex-column messageBox"
                                     id="messenger-container1" style="width: 100% !important;">
                                        ...
                                        <div style="display: flex; margin: 9px 0 -4px 33px;">
                                            ...
                                            <div>
                                                <p style="margin-left: 10px;">
                                                    ...
                                                    <br> <span style="color: grey; padding: 0px">Online</span>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        @foreach ($messages as $message)
                                            @if ($message['sender_id'] === $logged_in_user_id)
                                                <div class="d-flex flex-row gap-1 justify-content-end">
                                                    <div class="rounded " style="max-width: 70%;margin-right: 10px">
                                                        ...
                                                        <div>
                                                            <p class="text-end" style="color: #58534C;font-size: 14px">
                                                                {{ $message['created_at'] ?? null }}</p>
                                                        </div>
                                                    </div>
                                                    <div>
                                                        <img src="{{ \App\Helpers\Helpers::getWebUser()['photo_url'] ? \App\Helpers\Helpers::getWebUser()['photo_url']['thumbnail_url'] : '' }}"
                                            ...
                                            @else
                                                <div class="d-flex flex-row gap-3 align-items-start">
                                                    <div>
                                                        <img src="{{ $chat_user['photo_url']['thumbnail_url'] ?? null }}" width="35"
                                                             height="35" style="border-radius: 50%;background-color: white">
                                                    </div>
                                                    <div class="rounded " style="max-width: 70%;">
                                                        <div class="bg-primary text-white  p-2"
                                                             style="font-size:small;background-color: #F7F5F4 !important;color:#000000 !important;border-radius: 0px 10px 10px 10px !important">
                                                            {{ $message['message'] }}</div>
                                                        <div>
                                                            <p class="text-start" style="color: #58534C;font-size: 14px">
                                                                {{ $message['created_at'] ?? null }}</p>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <div style="width: 92%; margin: auto; margin-top: 10px">
                                        <form wire:submit.prevent="sendMessage" class="messenger-input-form d-flex">
                            ...
                            @else
                                <div class="messenger-cards d-block show-messenger w-md-75 d-flex flex-column justify-content-center align-items-center"
