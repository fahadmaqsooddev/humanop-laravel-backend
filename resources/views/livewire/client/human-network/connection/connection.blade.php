                                    ...
                                    <div class="card text-center shadow-sm" style="width: 17rem; height: 17rem; padding:0; border-radius: 8px;">
                                        <div class="card-body d-flex flex-column justify-content-end" style="height: 40%; padding: 0;">
                                            ...
                                            <div class="d-flex flex-row justify-content-center flex-1" style="color: rgb(74, 74, 74);padding:5px 0px; border-top: 1px solid black;">
                                                ...
                                                <div class="p-2">
                                                    <a class="btn btn-success" wire:click="connectUnConnectUser({{$connection_request->user->id ?? null}},'accept')">Accept</a>
                                                </div>
                                                ...
                                                <div class="p-2">
                                                    <a class="btn btn-secondary" wire:click="connectUnConnectUser({{$connection_request->user->id ?? null}},'un-connect')">Cancel</a>
                                                </div>
