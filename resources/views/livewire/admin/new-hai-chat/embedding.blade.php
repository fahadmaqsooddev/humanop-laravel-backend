...
<div>
    ...
    <div class="py-2">
        <div id="chat_switch_loader">
            ...
            <div wire:loading.flex wire:target="editEmbedding" class="spinner-border custom-text-dark"
                 id="chat_switch_spinner" role="status"
                ...
                <div class="modal-body" style="padding: 25px 30px;">
                    ...
                    <div class="py-1">
                        ...
                        <form wire:submit.prevent="createEmbedding" enctype="multipart/form-data">
                            ...
                            <div class="py-3">
                                <label class="py-2"
                                       style="font-weight: 600;font-size: 19px;line-height: 100%;color: white; display: block;">
                                    Name
                                </label>
                                <input type="text"
