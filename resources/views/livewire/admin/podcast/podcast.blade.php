                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 mt-4"
                                        ...
                                        <input class="form-control input-form-style"
                                               type="file"
                                               wire:model="audio_file" {{-- ✅ lowercase --}}
                                               id="audioInput"
                                               accept="audio/*"
                                        ...
                                        <span wire:loading wire:target="audio_file"
                                    ...
                                    <div class="col-12 mt-4"
                                        ...
                                        <input class="form-control input-form-style"
                                               type="file"
                                               wire:model="thumbnail_file" {{-- ✅ lowercase --}}
                                               id="thumbnailInput"
                                               accept="image/*"
                                               style="background-color:#eaf3ff;">
    ...
    <div wire:ignore.self class="modal fade" id="editFormPodcastModal" tabindex="-1"
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-body" style=" border-radius: 9px">
                    <div class="card-body pt-0">
                        <label class="form-label fs-4" style="color: #1b3a62">Edit Podcast Audio</label>
                            ...
                            <div class="card-body pt-0">
                                <div class="row">
                                    ...
                                    <div class="col-12 mt-4"
                                        ...
                                        <input class="form-control input-form-style"
                                               type="file"
                                               wire:model="audio_file" {{-- ✅ always lowercase --}}
                                               id="audioInput"
                                               accept="audio/*"
                                               style="background-color:#eaf3ff;">
