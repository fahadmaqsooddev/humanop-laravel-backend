                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="d-flex h-100" style="align-items: center">
                            <h2 class="font-weight-bolder custom-text-dark mb-0">Media Player</h2>
                    ...
                    <div class="col-lg-6">
                        ...
                        <button data-bs-toggle="modal" data-bs-target="#createResource" wire:click="emptyCreateForm"
                                ...
                                style="background:#1b3a62;color:white;font-weight:bolder;border:none;">Create Media
                            Player Resource
                        </button>
                    </div>
                </div>
            ...
            @foreach($categories as $category)
                ...
                <div class="col-12">
                    <div class="collapse pb-3" id="collapse-{{$category->name}}">
                        <div class="card-body p-3">
                            <div class="row">
                                @foreach($category['MediaPlayerResources'] as $resource)
                ...
                <div class="modal-body" style=" border-radius: 9px">
                    <form wire:submit.prevent="CreateResource" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-12">
                                    <label class="form-label fs-4" style="color: #1b3a62">Create Media Player
                                        Resource</label>
                                    <button type="button" class="close modal-close-btn" data-bs-dismiss="modal"
                                            aria-label="Close">
                                        <span aria-hidden="true">&times;</span>
                                    ...
                                    <div class="form-group mt-4">
                                        ...
                                        <select class="form-control input-form-style" wire:model.defer="category_id"
                                    ...
                                    <div class="form-group mt-4">
                                        ...
                                        <input class="form-control input-form-style" wire:model.defer="heading"
                                               placeholder="heading" type="text" maxlength="150">
                                    </div>
                                    ...
                                    @if($showThumbnailUpload)
                                        <div class="form-group" x-data="{ progress: 0 }"
                                             ...
                                             x-on:livewire-upload-finish="progress = 0"
                                             x-on:livewire-upload-error="progress = 0">
                                            <label class="form-label fs-4" style="color: #1b3a62">Thumbnail Image Upload
                                                [PNG, JPG, GIF, JPEG]</label>
                                            <input wire:model="thumbnail_file" id="thumbnail_file"
                                                   class="form-control input-form-style thumbnail_file" type="file"
                                                   accept="image/*">
                                            {{-- Progress bar --}}
                                            <div class="progress mt-2" x-show="progress > 0">
                                                <div class="progress-bar" role="progressbar"
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="form-group mt-4" wire:ignore>
                                        ...
                                        <textarea class="form-control input-form-style"
                                                  id="resourse_editor" name="update_description" wire:model="update_description"
                                                  rows="10">
                                        </textarea>
                                    </div>
...
{{--    @endif--}}
    ...
    <div wire:ignore.self class="modal fade" id="createCategory" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-md" role="document">
            <div class="modal-content">
                <div class="modal-body" style=" border-radius: 9px">
                    <label class="form-label fs-4" style="color: #1b3a62">Create Media Player Category</label>
    ...
    <script type="module">
            ...
            ClassicEditor
                ...
                .then(editor => {
                    ...
                    Livewire.on('editorContentUpdated', content => {
                        editor.setData(description); // Set new content into CKEditor
                    });
        ...
        if (updateEditorElement && !updateEditorElement.classList.contains('ck-editor')) { // Check if not already initialized
            ClassicEditor
                ...
                .then(editor => {
                    editor.model.document.on('change:data', () => {
                    @this.set('update_description', editor.getData())
                        ;
                    })
    ...
    <script>
        ...
        function confirmDeleteCategory(category_id) {
            ...
            swalWithBootstrapButtons.fire({
                ...
                html: "<span style='color: white;'>Want to delete category and it's Media Player resources permanently!</span>",
