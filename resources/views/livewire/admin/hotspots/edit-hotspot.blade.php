...
@endpush
<form wire:submit.prevent="updateHotspot">
    @include('layouts.message')
    <input type="hidden" wire:model.defer="select_code.id">
    <div class="row">
        <div class="col-12">
            <label class="form-label" style="color: #1b3a62">HotSpot Number</label>
            <div class="input-group">
                <input  name="name"
                       class="form-control input-form-style" type="text" wire:model.defer="select_hotspot.hotspot">
            </div>
        </div>
        <div class="col-12 mt-4">
            ...
            <div class="input-group">
                <input  name="public_name"
                       class="form-control input-form-style" type="text" wire:model.defer="select_hotspot.name"
                       placeholder="Alec">
            </div>
        </div>
    </div>
    <button class="btn btn-sm float-end mt-6 mb-0 text-white" style="background-color: #1b3a62">Update Hotspot</button>
</form>
        ...
        summernoteElement.summernote({
            ...
            callbacks: {
                onChange: function (contents, $editable) {
                    @this.
                    set('select_hotspot.text', contents);
                }
            }
        });
        ...
        ClassicEditor
            ...
            .then(editor => {
                editor.model.document.on('change:data', () => {
                    @this.
                    set('select_hotspot.text', editor.getData());
                })
