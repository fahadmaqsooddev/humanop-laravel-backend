    ...
    <div class="row">
        ...
        <div class="card card-bg-white-orange-border mt-4" id="prompt">
            ...
            <div class="card-body d-sm-flex pt-0 justify-content-end">
                <button wire:click="createCluster" class="float-end cluster-buttons py-1 px-3">

                    <span wire:loading.remove wire:target="createCluster">CREATE NEW CLUSTER</span>

                    <span wire:loading wire:target="createCluster">CREATING...</span>
