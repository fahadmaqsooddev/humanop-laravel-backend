            ...
            <div class="modal-body" style=" border-radius: 9px">
                ...
                <div class="card-body pt-0">
                    <label class="form-label fs-4" style="color: #1b3a62"><span>Daily Tip</span>
                        ...
                        <span style="margin-left: 10px">
                              <input type="radio" name="subscription_type" value="Core" wire:model="subscription_type"
                                     wire:change="changeSubscriptionType"> Core
                        </span>
                        <span style="margin-left: 10px">
                              <input type="radio" name="subscription_type" value="Premium"
                                     wire:model="subscription_type" wire:change="changeSubscriptionType"> Premium
                        </span>
                    </label>
                                ...
                                <div class="card">
                                    <div class="table-responsive ">
                                        <table class="table table-flush"
                                               style="border-collapse: separate;table-layout: fixed; width: 100%;">
                                            <thead class="thead-light">
                                            <tr style="">
...
@push('javascript')
    ...
    <script type="module">
        ...
        let editorInstance;
        const editorElement = document.getElementsByClassName('editor');
