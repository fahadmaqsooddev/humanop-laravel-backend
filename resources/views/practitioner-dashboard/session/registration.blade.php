            ...
            <div class="row mt-lg-n10 mt-md-n11 mt-n10 justify-content-center">
                <div class="col-xl-5 col-lg-5 col-md-7 mx-auto">
                    <div class="card z-index-0">
                        ...
                        <div class="card-body">
                            <form action="{{\App\Helpers\Practitioner\PractitionerHelpers::makePractitionerUrl('register-client-to-practitioner')}}" method="post">
                                @csrf
                                <input type="hidden" name="referralCode" value="{{$referralCode ?? ''}}">
                                <div>
                                    <div class="">
                                        <input type="text" class="form-control"
                                               value="{{$slug}}" name="slug" hidden
                                               style="background-color: #0F1535; color: white; border-radius: 15px;">
                                        <input type="text" class="form-control" name="slug2" value="{{$slug2}}" hidden
                                               style="background-color: #0F1535; color: white; border-radius: 15px;">
                                ...
                                <p class="text-sm mt-3 mb-0" style="color: rgb(160, 174, 192)">Already have an account?
                                    <a href="{{ \App\Helpers\Practitioner\PractitionerHelpers::makePractitionerUrl('login')}}" class="text-dark font-weight-bolder">Sign in</a>
                                </p>
                            </form>
                        </div>
                    </div>
