...
{{--    </a>--}}
{{--</div>--}}
<aside id="#remove-scrollbar-nav" style="z-index: 1024; !important;width: 155px;margin-left: 30px;border-radius: 40px !important;background: #1C365E !important"
       class="mt-4 mb-4 sidenav sidenavHideClass navbar navbar-vertical navbar-expand-xs border-0   {{ (\Request::is('pages-rtl') ? 'fixed-end me-3 rotate-caret' : 'fixed-start' ) }} "
       id="sidenav-main">
    <div class="d-flex">
                                ...
                                <a class="nav-link {{ (Request::is('admin-dashboard') ? 'active' : '') }}"
                                   href="{{ route('admin_dashboard') }}">
                                    <span class="sidenav-mini-icon"><img style="width: 18px; margin-right: 10px"
                                                                         src="{{URL::asset('assets/new-design/icon/dashboard/navbar/home.svg')}}"></span>
            ...
            @elseif((\Illuminate\Support\Facades\Auth::user()->is_admin == 2) && (\Illuminate\Support\Facades\Auth::user()->practitioner_id == null))
                <li class="nav-item">
                    ...
                    <div class="collapse {{ ($parentFolder == 'client-dashboard' ? ' show' : '') }}"
                        ...
                        <ul class="nav">
                            <li class="nav-item text-center mt-2 {{ (Request::is('client/dashboard')  ? 'active' : '') }}">
                                <a class="pb-1 {{ (Request::is('client/dashboard')  ? 'active' : '') }} "
                                   href="{{ route('client_dashboard') }}">
                                    <span >
                                        <img class="icon-size" src="{{URL::asset('assets/new-design/icon/dashboard/navbar/home.svg')}}">
                                    </span>
                                </a>
                                <p class="sidenav-normal" style="color: #F4E3C7 !important;font-size: 14px"> Dashboard </p>
                            </li>
                            <li class="nav-item text-center mt-2 {{ (Request::is('client/stripe-checkout')  ? 'active' : '') }}"   data-step="1" >
                                <a class=" pb-1 {{ (Request::is('client/stripe-checkout')  ? 'active' : '') }}"
                                   href="{{ url('client/intro-assessment') }}">
                                    <span><img class="icon-size" src="{{URL::asset('assets/new-design/icon/dashboard/navbar/graph.svg')}}"> </span>
                                    {{--                                    <span class="sidenav-normal"> Assessment </span>--}}
                                </a>
                                <p class="sidenav-normal" style="color: #F4E3C7 !important;font-size: 14px"> Assessment </p>
                            </li>
                            <li class="nav-item text-center mt-2 {{ (Request::is('client/all-assessments')  ? 'active' : '') }}">
                                <a class=" pb-1 {{ (Request::is('client/all-assessments')  ? 'active' : '') }}"
                                   href="{{ route('all_assessment') }}">
                                    <span ><img class="icon-size" src="{{URL::asset('assets/new-design/icon/dashboard/navbar/notepad.svg')}}"></span>
                                    {{--                                    <span class="sidenav-normal"> Results </span>--}}
                                </a>
                                <p class="sidenav-normal" style="color: #F4E3C7 !important;font-size: 14px"> Results </p>
                            </li>

                            <li class="nav-item text-center mt-2 {{ (Request::is('client/resource') ? 'active' : '') }}">
                                <a class=" pb-1 {{ (Request::is('client/resource') ? 'active' : '') }}"
                                   href="{{ route('resource') }}">

                                    <span ><img
                                            class="icon-size"          src="{{URL::asset('assets/new-design/icon/dashboard/navbar/football.svg')}}"></span>
                                    {{--                                    <span class="sidenav-normal"> Resources & Trainings </span>--}}
                                </a>
                                <p class="sidenav-normal" style="color: #F4E3C7 !important;font-size: 14px"> Resources <br>& Trainings </p>
                            </li>
                            <li class="nav-item mt-2">
                                <div class="text-center">
                                    <a class=" pb-2  {{ ($childFolder == 'human-network' ? 'active' : '') }}">
                                        <span ><img class="icon-size" src="{{URL::asset('assets/new-design/icon/dashboard/navbar/network.svg')}}"></span>
                                ...
                                <div class="collapse {{ ($childFolder == 'human-network' ? 'show' : '') }}"
                                    ...
                                    <ul class="nav nav-sm flex-column" style="margin-left: 15px">
                                        <li class="nav-item {{ (Request::is('connections') ? 'active' : '') }}">
                                            ...
                                            <a class="nav-link px-0 mx-0 {{ (Request::is('connections') ? 'active' : '') }}"
                                        ...
                                        <li class="nav-item {{ (Request::is('client/messages') ? 'active' : '') }}">
                                            <a class="nav-link px-0 mx-0 {{ (Request::is('client/messages') ? 'active' : '') }}"
                                               href="{{ route('messages') }}">
                                                <span><img
                                        ...
                                        <li class="nav-item {{ (Request::is('client/connections') ? 'active' : '') }}">
                                            <a class="nav-link px-0 mx-0 {{ (Request::is('client/connections') ? 'active' : '') }}"
                                        ...
                                        <li class="nav-item {{ (Request::is('client/follow') ? 'active' : '') }}">
                                            <a class="nav-link  px-0 mx-0 {{ (Request::is('client/follow') ? 'active' : '') }}"
                            ...
                            <li class="nav-item mt-4">
                                <div class="text-center">
                                    <a class="pb-2  {{ ($childFolder == 'support' ? 'active' : '') }}"
                                    >
                                    <span ><img class="icon-size"
                                                src="{{URL::asset('assets/new-design/icon/dashboard/navbar/tool.svg')}}"></span>
                            ...
                            <li class="nav-item text-center mt-2 {{ (Request::is('client/pricing') ? 'active' : '') }}">
                                <a class=" pb-1 {{ (Request::is('client/pricing') ? 'active' : '') }}"
                                   href="{{ route('client_pricing') }}">
                                    <span ><img class="icon-size"
                                                src="{{URL::asset('assets/new-design/icon/dashboard/navbar/crown.svg')}}"></span>
                                    {{--                                    <span class="sidenav-normal"> Pricing </span>--}}
                                </a>
                                <p class="sidenav-normal" style="color: #F4E3C7 !important;font-size: 14px"> Pricing </p>
                            </li>
                            <li class="nav-item text-center mt-2 {{ (Request::is('client/setting') ? 'active' : '') }}">
                                <a class=" pb-1 {{ (Request::is('client/setting') ? 'active' : '') }}"
                                   href="{{ route('setting') }}">
                                    <span ><img class="icon-size"
                                                src="{{URL::asset('assets/new-design/icon/dashboard/navbar/setting.svg')}}"></span>
                                    {{--                                    <span class="sidenav-normal"> Setting </span>--}}
                                </a>
                                <p class="sidenav-normal" style="color: #F4E3C7 !important;font-size: 14px"> Setting </p>
                            </li>
                            ...
                            <li class="nav-item text-center mt-2">
                                <a class=" pb-1"
                                   href="{{ url('/logout')}}">
                                    <span><img class="icon-size"
                                               src="{{URL::asset('assets/new-design/icon/dashboard/navbar/logout.svg')}}"></span>
                                    {{--                                    <span class="sidenav-normal text-bold"> Sign Out </span>--}}
                                </a>
