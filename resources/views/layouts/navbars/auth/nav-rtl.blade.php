...
<nav class="navbar navbar-main  navbar-expand-lg mt-4 top-1 px-0 mx-4 shadow-none border-radius-xl z-index-sticky" id="navbarBlur" data-scroll="true">
    ...
    <div class="collapse navbar-collapse  mt-sm-0 mt-2 px-0" id="navbar">
        ...
        <li class="nav-item d-flex align-items-center">
            <a href="/authentication-signin-illustration" class="nav-link text-body font-weight-bold px-0" target="_blank">
        ...
        <li class="nav-item dropdown ps-2 d-flex align-items-center">
            ...
            <li class="mb-2">
                ...
                <div class="d-flex py-1">
                    <div class="my-auto">
                    <img src="{{ URL::asset('assets/img/team-2.jpg') }}" class="avatar avatar-sm  ms-3 " alt="user image">
                    </div>
            ...
            <li class="mb-2">
                ...
                <div class="d-flex py-1">
                    <div class="my-auto">
                    <img src="{{ URL::asset('assets/img/small-logos/logo-spotify.svg') }}" class="avatar avatar-sm bg-gradient-dark  ms-3 " alt="logo spotify">
                    </div>
                    <div class="d-flex flex-column justify-content-center">
                    <h6 class="text-sm font-weight-normal mb-1">
