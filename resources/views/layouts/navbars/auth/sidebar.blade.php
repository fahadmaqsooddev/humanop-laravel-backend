<aside id="remove-scrollbar-nav" style="z-index: 9999; overflow:scroll !important;"
            ...
            <a class="align-items-center d-flex m-0 text-wrap" href="{{ route('admin_dashboard') }}">
                ...
                <span class="humanopMiniLogo d-none">
                    <img src="{{ URL::asset('assets/img/Human_OP.png') }}" class="h-100"
                        style="margin-left: 10px; width: 77px" alt="main_logo">
                </span>
            </a>
        </div>
    ...
    <div class="collapse navbar-collapse w-auto h-auto overflow-scroll" id="sidenav-collapse-main">
        <ul class="navbar-nav">
                                        ...
                                        <ul class="nav nav-sm flex-column">
                                            ...
                                            {{-- <li class="nav-item {{ (Request::is('admin/daily-tip') ? 'active' : '') }}">
                                                ...
                                                {{-- <a class="nav-link {{ (Request::is('admin/daily-tip') ? 'active' : '') }}"
                                                    ...
                                                    {{-- <span class="sidenav-mini-icon"><img
                                                            style="width: 18px; margin-left: 28px; margin-right: 10px"
                                                            src="{{URL::asset('assets/icons/Tip.png')}}"></span>--}}
                                                    {{-- <span class="sidenav-normal"><img
                                                            style="width: 18px; margin-left: 28px; margin-right: 10px"
                                                            src="{{URL::asset('assets/icons/Tip.png')}}"></span>--}}
