<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 {{ (\Request::is('pages-rtl') ? 'fixed-end me-3 rotate-caret' : 'fixed-start ms-3' ) }}" id="sidenav-main">
    ...
    <div class="collapse navbar-collapse w-auto h-auto" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            <li class="nav-item">
                <a data-bs-toggle="collapse" href="#dashboardsExamples" class="nav-link {{ ($parentFolder == 'dashboards' ? ' active' : '') }}"
                ...
                <div class="collapse {{ ($parentFolder == 'dashboards' ? ' show' : '') }}" id="dashboardsExamples">
                    <ul class="nav ms-4 ps-3">
                        <li class="nav-item {{ (Request::is('admin-dashboard') ? 'active' : '') }}">
                            <a class="nav-link {{ (Request::is('admin-dashboard') ? 'active' : '') }}" href="{{ route('admin_dashboard') }}">
                            <span class="sidenav-mini-icon"> D </span>
                            <span class="sidenav-normal"> Dashboard </span>
                        </a>
                        </li>
                        <li class="nav-item {{ (Request::is('users') ? 'active' : '') }}">
                            <a class="nav-link {{ (Request::is('users') ? 'active' : '') }}" href="{{ route('admin_all_users') }}">
                            ...
                            <div class="collapse {{ ($childFolder == 'virtual' ? 'show' : '') }}" id="vrExamples">
                                <ul class="nav nav-sm flex-column">
                                    ...
                                    <li class="nav-item {{ (Request::is('dashboard-cms') ? 'active' : '') }}">
                                        <a class="nav-link {{ (Request::is('dashboard-cms') ? 'active' : '') }}" href="{{ route('admin_cms') }}">
                        ...
                        <li class="nav-item {{ (Request::is('') ? 'active' : '') }}">
                            ...
                            <a class="nav-link {{ (Request::is('pages-account-settings') ? 'active' : '') }}" href="{{ route('admin_setting') }}">
