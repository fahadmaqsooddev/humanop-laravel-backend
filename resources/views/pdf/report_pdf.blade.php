                        ...
                        <div class="card" style="text-align: center">
                            <div class="card-body p-3 ">
                                ...
                                @foreach($allStyles as $style)
                                    ...
                                    <h2 class="mt-4"
                                        style="color: #f2661c; text-align: justify">{{ $styleHeading }}</h2>
                                    <p class="text-white" style="text-align: justify">{{ $styleText }}</p>
                                @endforeach
