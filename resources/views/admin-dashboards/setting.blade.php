    ...
    <div class="container-fluid my-3 py-3">
        ...
        <div class="row mb-5">
                            ...
                            <li class="nav-item pt-2">
                                <a class="nav-link text-body setting-options" data-scroll=""
                                   href="#practitionerTimezone">
                                    ...
                                    <span class="text-sm custom-text-dark">Change Timezone</span>
                                </a>
                            </li>
                        @endif
            ...
            <div class="col-lg-9 mt-lg-0 mt-4">
                <!-- Card Profile -->
                <div class="card card-body" style="background-color: white !important; border: 2px solid #1b3a62" id="profile">
                    <div class="row">
