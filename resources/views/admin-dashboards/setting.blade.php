                    ...
                    <ul class="nav flex-column border-radius-lg p-3" style="background-color: #0f1535">
                        ...
                        <li class="nav-item pt-2">
                            <a class="nav-link text-body" data-scroll="" href="#2fa">
                                ...
                                <span class="text-sm text-white">2FA</span>
                            </a>
                        </li>
                        <li class="nav-item pt-2">
                        ...
                        <li class="nav-item pt-2">
                            <a class="nav-link text-body" data-scroll="" href="#sessions">
                                ...
                                <span class="text-sm text-white">Sessions</span>
                            </a>
                        </li>
                        <li class="nav-item pt-2">
                    ...
                    <div class="row justify-content-center align-items-center">
                        ...
                        <div class="col-sm-auto ms-sm-auto mt-sm-0 mt-3 d-flex">
                            ...
                            <div class="form-check form-switch ms-2">
                                <input style="background-color: #0f1534;" class="form-check-input" sty type="checkbox"
                    ...
                    <div class="card-body pt-0">
                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                ...
                                <div class="input-group">
                                    <input style="background-color: #0f1534;" id="confirmation" name="confirmation"
                                           class="form-control" type="email" placeholder="example@email.com">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-6">
                                ...
                                <div class="input-group">
                                    <input style="background-color: #0f1534;" id="location" name="location"
                            ...
                            <div class="col-6">
                                ...
                                <div class="input-group">
                                    <input style="background-color: #0f1534;" id="phone" name="phone"
                                           class="form-control" type="number" placeholder="+40 735 631 620">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <input style="background-color: #0f1534;" class="form-control" id="choices-skills"
                                       type="text" value="vuejs, angular, react" placeholder="Enter something"/>
                            </div>
                        </div>
                    </div>
                </div>
