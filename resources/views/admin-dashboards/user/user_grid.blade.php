                    ...
                    <div class="table-responsive">
                        <table class="table table-flush" style="border-collapse: separate">
                            ...
                            <tr>
                                ...
                                <td class="text-sm font-weight-normal text-center border border-white @if(in_array('gre', array_keys($grid_code_color))) {{ $grid_code_color['gre'] }} @endif">@if($grid['jo'] > 6){{$second_row_gre = $grid['mer'] + $grid['jo']}}@else {{$second_row_gre = $grid['mer']}} @endif</td>
