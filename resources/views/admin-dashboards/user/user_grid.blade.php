                ...
                <div class="card left-nav-blue-light-color" style="background-color: white !important">
                    <div class="table-responsive">
                        <table class="table table-flush" style="border-collapse: separate">
                            ...
                            <tbody>
                            <tr>
                                <td style="border: 2px solid #1b3a62; color: #1b3a62" class="text-sm font-weight-normal text-center {{ isset($gridCodeColor['sa']) ? ($gridCodeColor['sa'] === 'green' ? 'greenBox' : ($gridCodeColor['sa'] === 'red' ? 'redBox' : ($gridCodeColor['sa'] === 'border-red' ? 'RedBorderBox' : ($gridCodeColor['sa'] === 'border-green' ? 'border-green' : '')))) : '' }}">{{$grid['sa']}}</td>
                                <td style="border: 2px solid #1b3a62 ; color: #1b3a62" class="text-sm font-weight-normal text-center {{ isset($gridCodeColor['ma']) ? ($gridCodeColor['ma'] === 'green' ? 'greenBox' : ($gridCodeColor['ma'] === 'red' ? 'redBox' : ($gridCodeColor['ma'] === 'border-red' ? 'RedBorderBox' : ($gridCodeColor['ma'] === 'border-green' ? 'border-green' : '')))) : '' }}">{{$grid['ma']}}</td>
                                <td style="border: 2px solid #1b3a62 ; color: #1b3a62" class="text-sm font-weight-normal text-center {{ isset($gridCodeColor['jo']) ? ($gridCodeColor['jo'] === 'green' ? 'greenBox' : ($gridCodeColor['jo'] === 'red' ? 'redBox' : ($gridCodeColor['jo'] === 'border-red' ? 'RedBorderBox' : ($gridCodeColor['jo'] === 'border-green' ? 'border-green' : '')))) : '' }}">{{$grid['jo']}}</td>
                                <td style="border: 2px solid #1b3a62 ; color: #1b3a62" class="text-sm font-weight-normal text-center {{ isset($gridCodeColor['lu']) ? ($gridCodeColor['lu'] === 'green' ? 'greenBox' : ($gridCodeColor['lu'] === 'red' ? 'redBox' : ($gridCodeColor['lu'] === 'border-red' ? 'RedBorderBox' : ($gridCodeColor['lu'] === 'border-green' ? 'border-green' : '')))) : '' }}">{{$grid['lu']}}</td>
                                <td style="border: 2px solid #1b3a62 ; color: #1b3a62" class="text-sm font-weight-normal text-center {{ isset($gridCodeColor['ven']) ? ($gridCodeColor['ven'] === 'green' ? 'greenBox' : ($gridCodeColor['ven'] === 'red' ? 'redBox' : ($gridCodeColor['ven'] === 'border-red' ? 'RedBorderBox' : ($gridCodeColor['ven'] === 'border-green' ? 'border-green' : '')))) : '' }}">{{$grid['ven']}}</td>
                                <td style="border: 2px solid #1b3a62 ; color: #1b3a62" class="text-sm font-weight-normal text-center {{ isset($gridCodeColor['mer']) ? ($gridCodeColor['mer'] === 'green' ? 'greenBox' : ($gridCodeColor['mer'] === 'red' ? 'redBox' : ($gridCodeColor['mer'] === 'border-red' ? 'RedBorderBox' : ($gridCodeColor['mer'] === 'border-green' ? 'border-green' : '')))) : '' }}">{{$grid['mer']}}</td>
                            ...
                            <tr>
                                <td style="border: 2px solid #1b3a62; color: #1b3a62" class="text-sm font-weight-normal text-center {{ isset($gridCodeColor['sa']) ? ($gridCodeColor['sa'] === 'green' ? 'greenBox' : ($gridCodeColor['sa'] === 'red' ? 'redBox' : ($gridCodeColor['sa'] === 'border-red' ? 'RedBorderBox' : ($gridCodeColor['sa'] === 'border-green' ? 'border-green' : '')))) : '' }}">{{$second_row_sa}}</td>
                                <td style="border: 2px solid #1b3a62; color: #1b3a62" class="text-sm font-weight-normal text-center {{ isset($gridCodeColor['ma']) ? ($gridCodeColor['ma'] === 'green' ? 'greenBox' : ($gridCodeColor['ma'] === 'red' ? 'redBox' : ($gridCodeColor['ma'] === 'border-red' ? 'RedBorderBox' : ($gridCodeColor['ma'] === 'border-green' ? 'border-green' : '')))) : '' }}">{{$second_row_ma}}</td>
                                <td style="border: 2px solid #1b3a62; color: #1b3a62" class="text-sm font-weight-normal text-center {{ isset($gridCodeColor['jo']) ? ($gridCodeColor['jo'] === 'green' ? 'greenBox' : ($gridCodeColor['jo'] === 'red' ? 'redBox' : ($gridCodeColor['jo'] === 'border-red' ? 'RedBorderBox' : ($gridCodeColor['jo'] === 'border-green' ? 'border-green' : '')))) : '' }}">{{$second_row_jo}}</td>
                                <td style="border: 2px solid #1b3a62; color: #1b3a62" class="text-sm font-weight-normal text-center {{ isset($gridCodeColor['lu']) ? ($gridCodeColor['lu'] === 'green' ? 'greenBox' : ($gridCodeColor['lu'] === 'red' ? 'redBox' : ($gridCodeColor['lu'] === 'border-red' ? 'RedBorderBox' : ($gridCodeColor['lu'] === 'border-green' ? 'border-green' : '')))) : '' }}">{{$second_row_lu}}</td>
                                <td style="border: 2px solid #1b3a62; color: #1b3a62" class="text-sm font-weight-normal text-center {{ isset($gridCodeColor['ven']) ? ($gridCodeColor['ven'] === 'green' ? 'greenBox' : ($gridCodeColor['ven'] === 'red' ? 'redBox' : ($gridCodeColor['ven'] === 'border-red' ? 'RedBorderBox' : ($gridCodeColor['ven'] === 'border-green' ? 'border-green' : '')))) : '' }}">{{$second_row_ven}}</td>
                                <td style="border: 2px solid #1b3a62; color: #1b3a62" class="text-sm font-weight-normal text-center {{ isset($gridCodeColor['mer']) ? ($gridCodeColor['mer'] === 'green' ? 'greenBox' : ($gridCodeColor['mer'] === 'red' ? 'redBox' : ($gridCodeColor['mer'] === 'border-red' ? 'RedBorderBox' : ($gridCodeColor['mer'] === 'border-green' ? 'border-green' : '')))) : '' }}">{{$second_row_mer}}</td>
                            ...
                            <tr>
                                <td style="border: 2px solid #1b3a62 ; color: #1b3a62" class="text-sm font-weight-normal text-center {{ isset($gridCodeColor['sa']) ? ($gridCodeColor['sa'] === 'green' ? 'greenBox' : ($gridCodeColor['sa'] === 'red' ? 'redBox' : ($gridCodeColor['sa'] === 'border-red' ? 'RedBorderBox' : ($gridCodeColor['sa'] === 'border-green' ? 'border-green' : '')))) : '' }}">{{$third_row_sa}}</td>
                                <td style="border: 2px solid #1b3a62 ; color: #1b3a62" class="text-sm font-weight-normal text-center {{ isset($gridCodeColor['ma']) ? ($gridCodeColor['ma'] === 'green' ? 'greenBox' : ($gridCodeColor['ma'] === 'red' ? 'redBox' : ($gridCodeColor['ma'] === 'border-red' ? 'RedBorderBox' : ($gridCodeColor['ma'] === 'border-green' ? 'border-green' : '')))) : '' }}">{{$third_row_ma}}</td>
                                <td style="border: 2px solid #1b3a62 ; color: #1b3a62" class="text-sm font-weight-normal text-center {{ isset($gridCodeColor['jo']) ? ($gridCodeColor['jo'] === 'green' ? 'greenBox' : ($gridCodeColor['jo'] === 'red' ? 'redBox' : ($gridCodeColor['jo'] === 'border-red' ? 'RedBorderBox' : ($gridCodeColor['jo'] === 'border-green' ? 'border-green' : '')))) : '' }}">{{$third_row_jo}}</td>
                                <td style="border: 2px solid #1b3a62 ; color: #1b3a62" class="text-sm font-weight-normal text-center {{ isset($gridCodeColor['lu']) ? ($gridCodeColor['lu'] === 'green' ? 'greenBox' : ($gridCodeColor['lu'] === 'red' ? 'redBox' : ($gridCodeColor['lu'] === 'border-red' ? 'RedBorderBox' : ($gridCodeColor['lu'] === 'border-green' ? 'border-green' : '')))) : '' }}">{{$third_row_lu}}</td>
                                <td style="border: 2px solid #1b3a62 ; color: #1b3a62" class="text-sm font-weight-normal text-center {{ isset($gridCodeColor['ven']) ? ($gridCodeColor['ven'] === 'green' ? 'greenBox' : ($gridCodeColor['ven'] === 'red' ? 'redBox' : ($gridCodeColor['ven'] === 'border-red' ? 'RedBorderBox' : ($gridCodeColor['ven'] === 'border-green' ? 'border-green' : '')))) : '' }}">{{$third_row_ven}}</td>
                                <td style="border: 2px solid #1b3a62 ; color: #1b3a62" class="text-sm font-weight-normal text-center {{ isset($gridCodeColor['mer']) ? ($gridCodeColor['mer'] === 'green' ? 'greenBox' : ($gridCodeColor['mer'] === 'red' ? 'redBox' : ($gridCodeColor['mer'] === 'border-red' ? 'RedBorderBox' : ($gridCodeColor['mer'] === 'border-green' ? 'border-green' : '')))) : '' }}">{{$third_row_mer}}</td>
