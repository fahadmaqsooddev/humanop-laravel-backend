        ...
        <div class="row">
            <div class="col-lg-3">
                <div class="position-sticky top-1">
                    ...
                    @livewire('admin.new-hai-chat.persona-listing')
                </div>
...
{{--            @endphp--}}
            <div class="col-lg-9 mt-lg-0 mt-4">
                ...
                @if(isset($brain) && $brain)
                    ...
                    @livewire('admin.new-hai-chat.persona',['chat_bot_id' => $brain['id']])

                    @livewire('admin.new-hai-chat.setting.prompt',['chat_bot_id' => $brain['id'], 'name' => $brain['name']])

                    @livewire('admin.new-hai-chat.setting.conversation',['chat_bot_id' => $brain['id'], 'name' => $brain['name']])

                @else

                    @livewire('admin.new-hai-chat.persona',['chat_bot_id' => null])

                    @livewire('admin.new-hai-chat.setting.prompt',['chat_bot_id' => null, 'name' => null])

                    @livewire('admin.new-hai-chat.setting.conversation',['name' => null, 'chat_bot_id' => null])
