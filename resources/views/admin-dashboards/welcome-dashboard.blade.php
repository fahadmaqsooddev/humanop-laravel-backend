...
@section('content')
    <main class="main-content" style="background-color: #eaf3ff; max-width: 99% !important;">
        <div class="col-lg-12 position-relative z-index-2" style="max-width: 99% !important;">
                            ...
                            <div class="card mb-4 input-form-style">
                                <div class="card-body p-3">
                                    <div class="row">
                                        <div class="col-8">
                                            <div class="numbers">
                                                <p class="text-md mb-0 text-capitalize font-weight-bold">B2C Admin
                                                    Dashboard</p>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="card mb-4 input-form-style">
                                <div class="card-body p-3">
                                    <div class="row">
                                        <div class="col-8">
                                            <div class="numbers">
                                                <p class="text-md mb-0 text-capitalize font-weight-bold">B2B Admin
                                                    Dashboard</p>
                                            </div>
                                        </div>
                                    </div>
            ...
            @endcanany
            @canany(['persona', 'brains', 'knowledge', 'advance', 'comparison','suggestions'])
                <div class="row" style="justify-content: center">
                    <div class="col-lg-5 col-sm-5 mt-3">
                            ...
                            <div class="card mb-4 input-form-style">
                                <div class="card-body p-3">
                                    <div class="row">
                                        <div class="col-8">
                                            <div class="numbers">
                                                <p class="text-md mb-0 text-capitalize font-weight-bold">HAi Admin
                                                    Dashboard</p>
                                            </div>
                                        </div>
                                    </div>
