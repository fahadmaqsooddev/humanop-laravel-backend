                            ...
                            <div class="col-12">
                                ...
                                <div class="input-group">
                                    <input style="background-color: #0f1534;" name="name"
                                           class="form-control text-white" type="text" value="{{$code['name']}}"
                                           placeholder="Alec">
                                </div>
                            </div>
                            <div class="col-12 mt-4">
                                ...
                                <div class="input-group">
                                    <input style="background-color: #0f1534;" name="public_name"
                                           class="form-control text-white" type="text" value="{{$code['public_name']}}"
                                           placeholder="Alec">
                                </div>
                            </div>
                            <div class="col-12 mt-4">
                                ...
                                <div class="input-group">
                                    <input style="background-color: #0f1534;" name="code"
                                           class="form-control text-white" type="text" value="{{$code['code']}}"
                                           placeholder="Alec">
                                </div>
                            </div>
                            <div class="col-12 mt-4">
                                ...
                                <div class="input-group">
                                    <input style="background-color: #0f1534;" name="type"
                                           class="form-control text-white" type="text" value="{{$code['type']}}"
                                           placeholder="Alec">
                                </div>
                            </div>
                            <div class="col-12 mt-4">
                                ...
                                <div class="input-group">
                                    <textarea rows="10" cols="10" style="background-color: #0f1534;" name="question"
                                              class="form-control text-white" type="text">{!! $code['text'] !!}</textarea>
                                </div>
                            </div>
                        </div>
