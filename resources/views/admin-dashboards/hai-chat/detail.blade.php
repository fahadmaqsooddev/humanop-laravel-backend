                    ...
                    <ul class="nav rainbow-border-user-nav-btn flex-column border-radius-lg p-3">
                        ...
                        <li class="nav-item">
                            <a class="nav-link setting-options text-body" data-scroll="" href="#keyword_restriction">
                                ...
                                <span class="text-sm custom-text-dark">Keyword Restrcition</span>
                            </a>
                        </li>
...
{{--                        </li>--}}
                        ...
                        {{-- analyticst --}}
                        <li class="nav-item pt-2">
                            <a class="nav-link text-body setting-options" data-scroll="" href="#analytics">
                                <div class="icon me-2">
                                    <svg class="text-dark mb-1" width="16px" height="16px" viewBox="0 0 42 42"
                                         version="1.1" xmlns="http://www.w3.org/2000/svg"
                                         xmlns:xlink="http://www.w3.org/1999/xlink">
...
{{--                                    </svg>--}}
{{--                                </div>--}}
{{--                                <span class="text-sm custom-text-dark">Comparison</span>--}}
{{--                            </a>--}}
{{--                        </li>--}}
