...
@section('content')
  ...
  <div class="container-fluid py-4">
    <section class="py-3">
      <div class="row">
        <div class="col-md-12 me-auto text-left text-white">
          <h5 class="text-white">Some of Our Awesome Projects</h5>
        ...
        <div class="col-lg-4 col-md-6 mb-4">
          <div class="card">
            <div class="card-body p-3">
              ...
              <p class="text-sm mt-3" style="color: rgb(160, 174, 192)"> If everything I did failed - which it doesn&#39;t, I think that it actually succeeds. </p>
        ...
        <div class="col-lg-4 col-md-6 mb-4">
          <div class="card">
            <div class="card-body p-3">
              ...
              <p class="text-sm mt-3" style="color: rgb(160, 174, 192)"> Pink is obviously a better color. Everyone’s born confident, and everything’s taken away from you. </p>
              <hr class="horizontal dark">
              <div class="row">
                <div class="col-6">
        ...
        <div class="col-lg-4 col-md-6 mb-4">
          <div class="card">
            <div class="card-body p-3">
              ...
              <p class="text-sm mt-3" style="color: rgb(160, 174, 192)"> Constantly growing. We’re constantly making mistakes from which we learn and improve. </p>
              <hr class="horizontal dark">
              <div class="row">
                <div class="col-6">
          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="d-flex">
                ...
                <div class="ms-3 my-auto">
                  <h6 class="text-white">Looking great</h6>
                  <div class="avatar-group">
                    <a href="javascript:;" class="avatar avatar-xs rounded-circle" data-bs-toggle="tooltip" data-original-title="Jessica Rowland">
                      <img alt="Image placeholder" src="{{ URL::asset('assets/img/team-3.jpg') }}" class="">
                    </a>
              ...
              <p class="text-sm mt-3" style="color: rgb(160, 174, 192)"> You have the opportunity to play this game of life you need to appreciate every moment. </p>
              <hr class="horizontal dark">
              <div class="row">
                <div class="col-6">
                  <h6 class="text-sm mb-0 text-white">6</h6>
                  <p class="text-secondary text-sm font-weight-bold mb-0">Participants</p>
                </div>
                <div class="col-6 text-end">
                  <h6 class="text-sm mb-0 text-white">14.03.24</h6>
                  <p class="text-secondary text-sm font-weight-bold mb-0">Due date</p>
                </div>
              </div>
            </div>
          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="d-flex">
                ...
                <div class="ms-3 my-auto">
                  <h6 class="text-white">Developer First</h6>
                  <div class="avatar-group">
                    <a href="javascript:;" class="avatar avatar-xs rounded-circle" data-bs-toggle="tooltip" data-original-title="Audrey Love">
                      <img alt="Image placeholder" src="{{ URL::asset('assets/img/team-4.jpg') }}" class="rounded-circle">
                    </a>
              ...
              <p class="text-sm mt-3" style="color: rgb(160, 174, 192)"> For standing out. But the time is now to be okay to be the greatest you. </p>
              <hr class="horizontal dark">
              <div class="row">
                <div class="col-6">
                  <h6 class="text-sm mb-0 text-white">4</h6>
                ...
                <div class="col-6 text-end">
                  <h6 class="text-sm mb-0 text-white">16.01.22</h6>
                  <p class="text-secondary text-sm font-weight-bold mb-0">Due date</p>
                </div>
              </div>
            </div>
        ...
        <div class="col-lg-4 col-md-6 mb-4">
          <div class="card">
            <div class="card-body p-3">
              <div class="d-flex">
                <div class="avatar avatar-xl bg-gradient-dark border-radius-md p-2">
                  <img src="{{ URL::asset('assets/img/small-logos/logo-webdev.svg') }}" alt="invision_logo">
                </div>
                <div class="ms-3 my-auto">
        ...
        <div class="col-lg-4 col-md-6 mb-4">
          <div class="card">
            <div class="card-body p-3">
              <div class="d-flex">
                <div class="avatar avatar-xl bg-gradient-dark border-radius-md p-2">
                  <img src="{{ URL::asset('assets/img/small-logos/logo-spotify.svg') }}" alt="invision_logo">
                </div>
                <div class="ms-3 my-auto">
                  <h6 class="text-white">Spotify Account</h6>
                  <div class="avatar-group">
                    <a href="javascript:;" class="avatar avatar-xs rounded-circle" data-bs-toggle="tooltip" data-original-title="Audrey Love">
                      <img alt="Image placeholder" src="{{ URL::asset('assets/img/team-4.jpg') }}" class="rounded-circle">
                    </a>
          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="d-flex">
                ...
                <div class="ms-3 my-auto">
                  <h6 class="text-white">Small Account</h6>
                  <div class="avatar-group">
                    <a href="javascript:;" class="avatar avatar-xs rounded-circle" data-bs-toggle="tooltip" data-original-title="Audrey Love">
                      <img alt="Image placeholder" src="{{ URL::asset('assets/img/team-4.jpg') }}" class="rounded-circle">
                    </a>
