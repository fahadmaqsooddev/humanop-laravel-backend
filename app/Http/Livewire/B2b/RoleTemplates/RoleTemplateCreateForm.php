...
public $tagInput = '';
    ...
    protected $listeners = ['updateEditTemplateValues', 'emptyTemplateValues', 'updateContent','resetForm'];
    ...
    public function updateEditTemplateValues($id, $code, $title, $description,$role_name, $subscription, $min_point, $max_point)
    {

        $this->resetPointArray();
        $this->emptyTemplateValues();
    ...
    public function emptyTemplateValues()
    {
    ...
    {
        return view('livewire.b2b.role-templates.role-template-create-form');
    }
