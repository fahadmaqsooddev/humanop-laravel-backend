...
class CoPilotTrait extends Component
{
    public $code = [];
    // public $heading='co-pilot';
    public $overview;
    public $optimal;
    public $optimization;
    ...
    public function update(){
        try {
            $this->validate();
            $result=AssessmentWalkThrough::storeData($this->overview,$this->code,$this->optimal,$this->optimization,Admin::CO_PILOT_TRAIT);
    ...
    {
        return view('livewire.admin.assessment-walkthrough.co-pilot-trait');
    }
}
