...
class ThirdTrait extends Component
{

    public $code = [], $heading = 'third', $overview, $optimal, $optimization;
    ...
    public function selectCode($selectedCode)
    {
        ...
        $result = AssessmentWalkThrough::getData(Admin::THIRD_TRAIT, $this->code);
    ...
    public function update()
    {
        try {
            ...
            $result = AssessmentWalkThrough::storeData($this->overview, $this->code, $this->optimal, $this->optimization, Admin::THIRD_TRAIT);
    ...
    public function render()
    {
        ...
        return view('livewire.admin.assessment-walkthrough.third-trait');
