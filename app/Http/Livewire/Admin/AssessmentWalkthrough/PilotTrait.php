...
class PilotTrait extends Component
{
    public $code = [], $heading = 'pilot', $overview, $optimal, $optimization;
    ...
    public function selectCode($selectedCode)
    {
        ...
        $result = AssessmentWalkThrough::getData(Admin::PILOT_TRAIT, $this->code);
    ...
    public function update()
    {
        try {
            ...
            $result = AssessmentWalkThrough::storeData($this->overview, $this->code, $this->optimal, $this->optimization, Admin::PILOT_TRAIT);
    ...
    public function render()
    {
        ...
        return view('livewire.admin.assessment-walkthrough.pilot-trait');
