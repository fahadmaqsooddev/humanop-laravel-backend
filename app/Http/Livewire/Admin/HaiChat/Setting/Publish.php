...
class Publish extends Component
{
    ...
    public function publishForm()
    {
        try {
            ...
            if (!empty($chatBotId) && !empty($chatSetting))
            {
                ...
                $aiReply = $this->sendRequestFromGuzzle('post', 'http://54.88.172.210:8000/save-llm-params', ['temperature' => $chatSetting['temperature'],'max_tokens' => $chatSetting['max_token'],'file_name' => $file_name, 'prompt_folder' => $this->bot_name, 'total_chunks' => $chatSetting['chunk'], 'gpt_model' => $gpt_model]);
    ...
    public function render()
    {
        ...
        return view('livewire.admin.hai-chat.setting.publish');
    }
}
