...
class HaiChat extends Component
{
    ...
    public function submitForm()
    {
        ...
        try {
            ...
            $aiReply = $this->sendRequestFromGuzzle('post', 'http://54.88.172.210:8000/create-chatbot', ['vendor_n' => $this->name]);
    ...
    public function deleteChatbot($id)
    {
        ...
        $aiReply = $this->sendRequestFromGuzzle('post', 'http://54.88.172.210:8000/delete-folder', ['folder_n' => $chat['name']]);
