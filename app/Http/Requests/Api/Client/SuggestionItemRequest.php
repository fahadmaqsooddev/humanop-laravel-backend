...
class SuggestionItemRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        ...
        return [
            'item_id' => 'required|exists:humanop_shop_resources,id',
    ...
    public function messages()
    {
        return [
            ...
            'item_id.exists' => 'The selected humanOp shop item does not exist.',
