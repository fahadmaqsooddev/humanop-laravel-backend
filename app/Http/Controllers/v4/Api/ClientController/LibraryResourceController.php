        ...
        try {
            ...
            foreach ($items as $item) {
                ...
                $transformed[] = [
                    ...
                    'video_url' => is_array($item->video_url ?? null) ? ($item->video_url['path'] ?? null) : ($item->video_url ?? null),
                    'audio_url' => is_array($item->audio_url ?? null) ? ($item->audio_url['path'] ?? null) : ($item->audio_url ?? null),
