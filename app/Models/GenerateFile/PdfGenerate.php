            ...
            foreach ($styles as $style) {
                ...
                if (isset($style['public_name'])) {
                    ...
                    switch ($style['public_name']) {
                        ...
                        case 'Sympathetic':
                            $styleHeading = 'Sympathetic';
                            $styleTextArray = [
                                "The Sympathetic Trait in you is what we call a “seeing” trait. This is a more passive part of you that sees what's needed in-the-moment to nurture the moment. Now, whether you are officially engaged in the healing arts or not, this part of you is the natural born healer in you. You have a genuine presentation of concern for others, and you innately send a signal to them that everything is gonna be okay. People feel this from you and it's what makes them feel safe and comfortable in your company. Now, in matters of managing a crisis, whether it be at home or at the office, because this part of you is very laid back and very relaxed, you are often the calm in the storm. You can easily shift to accommodate successful outcomes, and this allows you to produce a response of acceptance in most any situation. And, in turn, often brings peace to the moment. Now the more pronounced this trait is in you, the more it’s necessary for you to ease into your day… and to ease into things. In other words, give yourself a little extra time in the morning and a little extra time getting to appointments.  And allow for extra time to step into engaging in projects as your relaxed nature is not a hurried nature. Now, in order to keep yourself optimized, this particular trait must recharge in the afternoon with a brief 20 to 30 minute power nap, specifically between 2 and 5. It's rejuvenating for you, so pay attention to your schedule at work at home or while you're traveling to accommodate this nap. It's the only trait that naturally benefits from the power nap, and incorporating this into your day is an important strategy. Many people find it's like they have a whole new day in terms of productivity after that power nap.",
                                "This is the more passive part of you that offers a very positive perspective, sending a signal that everything is going to be okay. In matters of managing a crisis, be it at the office or at home, you are often the calm in the storm. You have a nurturing quality and a genuine presentation of concern for others. People feel this when in your company because it is authentic. This is one of the many things people like about you. You are very relaxed and inviting and adapt easily to new environments. This allows you to produce a response of acceptance in any situation allowing you to become whatever you need to be to be successful. To embrace the natural talents of this trait, you must recharge midday with a brief power nap or longer if possible. Organize your schedule at work or while traveling to accommodate this. Whole countries with this same trait are known to shut down between 2 and 5 p.m. Don't go without."
                            ];
                            break;
