...
//            'hidden' => ['updated_at']
        ...
        'ActionPlan' => [
            'table' => 'action_plans',
            'fillable' => ['plan_text', 'user_id', 'updated_at', 'text', 'assessment_id', 'priority', 'type', 'execute_at'],
            'hidden' => ['created_at'],
        ],
        'ResourceCategory' => [
        ...
        'LibraryResourceDocument' => [
            'table' => 'library_resource_documents',
