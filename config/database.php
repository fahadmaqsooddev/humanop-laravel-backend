...
return [
    ...
    */
    ...
    'models' => [
        ...
        'Assessment' => [
            'table' => 'assessments',
            'fillable' => ['user_id', 'page','sa','ma','jo','lu','ven','mer','so','de','dom','fe','gre','lun','nai','ne','pow','sp','tra','van','wil','g','s','c','em','ins','int','mov','created_at','type','updated_at','reset_assessment','web_page','app_page'],
//            'hidden' => ['updated_at']
        ],
        'AssessmentDetail' => [
        ...
        'LibraryResource' => [
            ...
            'fillable' => ['heading','slug','upload_id','resource_category_id','description','content','source_id','source_url'],
            'hidden' => ['updated_at', 'created_at'],
        ],
        'PermissionResource' => [
