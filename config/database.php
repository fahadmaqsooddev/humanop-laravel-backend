...
return [
    ...
    */
    ...
    'models' => [
        ...
        'Assessment' => [
            'table' => 'assessments',
            'fillable' => ['user_id', 'page','sa','ma','jo','lu','ven','mer','so','de','dom','fe','gre','lun','nai','ne','pow','sp','tra','van','wil','g','s','c','em','ins','int','mov','created_at','type','updated_at','reset_assessment'],
//            'hidden' => ['updated_at']
        ],
        'AssessmentDetail' => [
        ...
        'DailyTip' => [
            'table' => 'daily_tips',
            'fillable' => ['title', 'description','code','user_id','is_read', 'text','subscription_type','point','interval_of_life'],
            'hidden' => ['created_at','updated_at']
        ],
        'TipRecord' => [
            'table' => 'tip_records',
        ...
        'LibraryResource' => [
            ...
            'fillable' => ['heading','slug','upload_id','resource_category_id','description','content'],
            'hidden' => ['updated_at', 'created_at'],
        ],
        'PermissionResource' => [
        ...
        'HaiChatSetting' => [
            ...
            'fillable' => ['id','temperature','max_token','chunk','model_type','chat_bot_id'],
            'hidden' => ['created_at','updated_at'],
        ],
        'HaiChatConversation' => [
