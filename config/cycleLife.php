...
return [
    ...
    'age(7-11)'=>[
        'public_name' => 'motivation_life_cycle',
        'description' => ` <p class="text-sm mt-3 fs-12px"
    ...
    'age(21-29)'=>[
        'public_name' => 'roadworthy_life_cycle',
        'description' => `                       <p class="text-sm mt-3 fs-12px"
    ...
    'age(34-42)'=>[
        'public_name' => 'mid_life_life_cycle',
        'description' => `           <p class="text-sm mt-3 fs-12px"
                                                   style="color: white; text-align: justify; font-size:1rem"><span
    ...
    'age(43-51)'=>[
        'public_name' => 'awareness_life_cycle',
        'description' => `    <p class="text-sm mt-3 fs-12px"
                                                   style="color: white; text-align: justify; font-size:1rem"><span
    ...
    'age(52-65)'=>[
        'public_name' => 'forward_life_cycle',
        'description' => `    <p class="text-sm mt-3 fs-12px"
                                                   style="color: white; text-align: justify; font-size:1rem"><span
    ...
    'age(66-69)'=>[
        'public_name' => 'liberated_life_cycle',
        'description' => `       <p class="text-sm mt-3 fs-12px"
                                                   style="color: white; text-align: justify; font-size:1rem"><span
